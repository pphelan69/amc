 ...
 */
public class cloudEditionAWSsubnetTest {
    ...
    @Test(description="Edit AWS-Subnet cloud definition and test the cancelling of its editing, with Locate by Subnet ID ")
    ...
    @Test(description="Edit AWS-Subnet cloud definition and verify entered values saved while editing cloud definition.")
    public void clouds_Edition_test2() {
        ...
        awsCloudPage.textfield_Type("Subnet ID", Constant.SubnetIdAWS);
        String value7= awsCloudPage.get_textfield_Value("Subnet ID");
        softAssert.assertTrue((value7.equals(Constant.SubnetIdAWS)), "verify the CloudSecretAccessKeyAWS.");

        /*awsCloudPage.textfield_Type("Security Group ID", Constant.SecurityGroupIdAWS);
        String value8= awsCloudPage.get_textfield_Value("Security Group ID");
        softAssert.assertTrue((value8.equals(Constant.SecurityGroupIdAWS)), "verify the CloudSecretAccessKeyAWS.");*/
    ...
    @Test(description="Verify AWS-Subnet cloud definition and save in Locate by Subnet ID")
    public void clouds_Edition_test3 () {
        ...
        RSCloudPage.radioButton_Select(Constant.SubnetIdZoneAWS);
        RSCloudPage.textfield_Type("Subnet ID",Constant.SubnetIdAWS);
       /* RSCloudPage.textfield_Type("Security Group ID", Constant.SecurityGroupIdAWS);
        ...
        RSCloudPage.reloadpage();  // added comparing == from != in below line
