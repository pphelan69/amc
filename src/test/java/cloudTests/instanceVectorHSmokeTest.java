...
public class instanceVectorHSmokeTest {
    ...
    @Test(description="RackSpace - Test provisioning VectorH on small cluster (4 nodes) on RackSpace")
    ...
    @Test(description="AWS - Test provisioning VectorH on small cluster (4 nodes) on AWS")
    ...
    @Test(description="AWS_Subnet - Test provisioning VectorH on small cluster (4 nodes) on AWS_Subnet")
